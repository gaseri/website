...
- [DPU offload of force reduction calculations in molecular dynamics simulations](../projects/index.md#dpu-offload-of-force-reduction-calculations-in-molecular-dynamics-simulations), funded by [NVIDIA](https://www.nvidia.com/), timeframe 2022–2023
- [EuroCC – National Competence Centres in the framework of EuroHPC](../projects/index.md#national-competence-centres-in-the-framework-of-eurohpc-eurocc), funded by [Horizon 2020](https://cordis.europa.eu/project/id/951732), timeframe 2020–2022
...
1. Škarica, M., Ašenbrener Katić, M. & **Miletić, V.** [Primjena kviza u nastavi matematike.](http://www.mipro.hr/_Events_/tabid/110/language/hr-HR/Default.aspx?event=MIPRO2021.CE) in *2021 44th International Convention on Information, Communication, and Electronic Technology (MIPRO)*, 996–1000 (2021).
...
1. **Miletić, V.** [Slobodni softver otvorenog koda – nositelj inovativnosti.](https://marjan.unist.hr/UserDocsImages/Portals/0/DMX/2017/11/Universitas%20-%20br.%2070_665.pdf) in [*Sveučilišni list Universitas*](https://www.unist.hr/universitas-17821/17821) **70**, edited by Tomislav Čižmić-Marović, 24. Split, Croatia (University of Split, 2015).
...
1. **Miletić, V.** [Ratovi web preglednika.](https://marjan.unist.hr/UserDocsImages/Portals/0/DMX/2017/11/Universitas%20-%20br.%2065_660.pdf) in [*Sveučilišni list Universitas*](https://www.unist.hr/universitas-17821/17821) **65**, edited by Tomislav Čižmić-Marović, 18–19. Split, Croatia (University of Split, 2015).
...
1. [Design of drugs using RxDock high-throughput molecular docking software](https://youtu.be/0GuQMdhOQVA), [Seminar of Department of Biotechnology, University of Rijeka](https://biotech.uniri.hr/popularizacija/predavanja-seminari-kongresi/), 2020.
...
1. [Ratovi web preglednika](https://youtu.be/pz73gD1H-s4), [Otvoreni dan sveučilišnih odjela](https://math.uniri.hr/dogadjanja/otvoreni-dan-sveucilisnih-odjela-2015/), 2015.
...
Description: [home page](https://github.com/an-tao/trantor).

Commits listed from [repository on GitHub](https://github.com/an-tao/trantor):

- commit [`bf9eae841366758810c8ff121ede0eef592c6420`](https://github.com/an-tao/trantor/commit/bf9eae841366758810c8ff121ede0eef592c6420): Added support for Solaris (#94)

    ??? note
        Tested on illumos distribution OmniOS Community Edition.

- commit [`d74f4475ef317da8fc968f1fb6aa8dbcc076c933`](https://github.com/an-tao/trantor/commit/d74f4475ef317da8fc968f1fb6aa8dbcc076c933): Use env to find bash in build.sh script to support FreeBSD (#87)
