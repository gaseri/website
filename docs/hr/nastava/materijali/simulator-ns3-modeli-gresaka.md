...
Pored toga, uočimo još nešto: "špičaste" zagrade su oznaka za [predloške](https://en.wikipedia.org/wiki/Template_(C++)) (engl. *templates*). Mi se ovdje definiranjem funkcija s predlošcima nećemo baviti, obzirom da ćete se s njima sresti na kolegiju Objektno orjentirano programiranje, već ćemo samo ukratko objasniti ideju i primjene.
