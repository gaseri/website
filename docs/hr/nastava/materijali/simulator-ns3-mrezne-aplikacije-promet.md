...
- `ZipfRandomVariable` ([dokumentacija](https://www.nsnam.org/docs/doxygen/classns3_1_1_zipf_random_variable.html)), koja vraća brojeve prema [Zipfovoj razdiobi](https://en.wikipedia.org/wiki/Zipf's_law).
