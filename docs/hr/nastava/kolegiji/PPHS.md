...
- [Python modul PyCUDA: korištenje tokova i asinkronih kopiranja memorije za poboljšanje performansi](../materijali/python-modul-pycuda-tokovi-asinkrone-operacije.md)
- [Python modul PyCUDA: rad s više GPU-a](../materijali/python-modul-pycuda-multi-gpu.md)

### Programiranje aplikacija za heterogene sustave korištenjem tehnologije OpenCL

- [Programiranje aplikacija za heterogene sustave korištenjem tehnologije OpenCL](../materijali/python-modul-pyopencl.md)

### Programiranje aplikacija za heterogenu sustavsku arhitekturu na platformi ROCm

- [Mjerenje brzine izvođenja C++ aplikacija](../materijali/cpp-timing-benchmarking.md)
- [rocPRIM: ROCm parallel PRIMitives](../materijali/rocm-rocprim.md)
- [Generiranje pseudoslučajnih brojeva u C++ aplikacijama](../materijali/cpp-std-random.md)
- [rocRAND: ROCm RANDom number generator](../materijali/rocm-rocrand.md)
- [BLAS i LAPACK](../materijali/netlib-blas-lapack.md)
- [C++ biblioteka predložaka za linearnu algebru Eigen](../materijali/cpp-eigen.md)
- [rocBLAS: ROCm Basic Linear Algebra Subprograms](../materijali/rocm-rocblas.md)
- [rocSOLVER: ROCm-ov linear algebra SOLVER](../materijali/rocm-rocsolver.md)
- [rocSPARSE: ROCm SPARSE basic linear algebra subroutines](../materijali/rocm-rocsparse.md)
- [rocALUTION: ROCm SPARSE Linear Algebra PACkage](../materijali/rocm-rocalution.md)
- [rocFFT: ROCm Fast Fourier Transforms](../materijali/rocm-rocfft.md)
