...
V2. (4 h) Rad s osnovnim funkcijama i postavljanje operacijskog sustava ([Windows Subsystem for Linux](https://learn.microsoft.com/windows/wsl/install), [Ubuntu](https://ubuntu.com/), [Debian](https://www.debian.org/), [FreeBSD](https://www.freebsd.org/)). Osnove programiranja ([Python](https://www.python.org/), [Visual Studio Code](https://code.visualstudio.com/), [Python extension for Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=ms-python.python))  
